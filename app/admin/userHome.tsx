...
import PriceFilter from "../../components/Lesson 13/PriceFilter";

// --- Import từ database.ts ---
import { fetchProducts, fetchCategories, Product, Category } from "../../components/Lesson 13/database";
...
export const ProductCard = ({
  ...
  <View style={styles.productCard}>
    <TouchableOpacity onPress={onPress}>
      <Image source={getProductImageSource(item.img)} style={styles.productImage} />
    </TouchableOpacity>
